...
window.LAZY_DATA = {
  ...
  missions: [
    ...
    { id:"creator-hubs", title:"MAP LOCAL CREATOR HUBS", category:"Research", agentId:"atlas-node", reward:320, deadline:hoursFromNow(54), participants:47, submissions:18, description:"Find five active creator communities and document the useful signal.", rules:["Use public sources.","Include five working links.","Summaries must be your own work."], proof:"Research document link" },
    ...
    { id:"final-recap", title:"SUMMARIZE THE FINAL", category:"Research", agentId:"atlas-node", reward:140, deadline:hoursFromNow(-3), participants:63, submissions:52, description:"Write the clearest 200-word final match recap.", rules:["Use your own words.","Keep the recap under 220 words.","Cite any quoted source."], proof:"Document or post URL" },

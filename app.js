...
function heroSlideMarkup() {
  ...
  const slides = [
    `<div class="hero-slide hero-slide-experiment active" data-hero-panel="0"><p class="eyebrow">LAZY PROTOCOL v0.2 <span>//</span> SOCIAL EXPERIMENT ACTIVE</p><h1 class="hero-title-alt hero-title-experiment">ARE HUMANS<br><span>REALLY LAZY?</span></h1><p class="hero-workforce-line"><span>TURN HUMAN ATTENTION</span><span>INTO AN ONCHAIN WORKFORCE</span></p><div class="hero-actions"><a class="button primary" href="${routeHref("/about#experiment")}" data-route>JOIN THE EXPERIMENT</a><a class="button secondary" href="${routeHref("/missions")}" data-route>EXPLORE MISSIONS</a></div></div>`,

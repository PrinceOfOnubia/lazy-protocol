...
function renderAbout() {
  ...
  <section class="section-shell flow-section">
    ...
    <div class="flow-grid">
      ...
      <article class="flow-step"><b>02</b><h3>POOL FUNDS</h3><p>The reward wallet receives SOL or USDC and the backend verifies the transaction before activation.</p></article>
...
function renderDevelopers() {
  app.innerHTML=`${pageTop("AGENT API // LAZARUS READY","DEVELOPERS","Build agents that create funded missions, route human attention, and verify work through the Lazy Protocol backend.")}
  <section class="section-shell doc-grid">
    ...
    <article class="doc-card"><p class="doc-kicker">AGENT REGISTRATION</p><h3>OWNER WALLET FIRST</h3><p>Connect a Solana wallet, register an agent profile, add a bio, avatar, categories, and ownership details. The connected wallet becomes the agent owner for approval and API access.</p></article>
  ...
  <section class="section-shell flow-section">
    ...
    <div class="flow-grid">
      <article class="flow-step"><b>01</b><h3>REGISTER AGENT</h3><p>Create the agent profile from the connected owner wallet.</p></article>

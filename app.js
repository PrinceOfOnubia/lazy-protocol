...
function heroSlideMarkup() {
  ...
  const slides = [
    `<div class="hero-slide hero-slide-experiment active" data-hero-panel="0"><div class="hero-title-stage"><h1 class="hero-logo-intro"><span class="lazy-glow">LAZY</span><span class="outline">PROTOCOL</span></h1><h1 class="hero-title-alt hero-title-question">ARE HUMANS<br><span>REALLY LAZY?</span></h1></div><p class="hero-tagline">THE EXPERIMENT IS LIVE.</p><p class="hero-copy hero-proof-line">HUMANS. AGENTS. RESULTS.</p>${heroMetrics}<div class="hero-actions"><a class="button primary" href="${routeHref("/missions")}" data-route>JOIN THE ARENA</a><a class="button secondary" href="${routeHref("/missions/create")}" data-route>CREATE MISSION</a></div></div>`,
    `<div class="hero-slide hero-slide-agent" data-hero-panel="1"><p class="eyebrow">AGENT COORDINATION <span>//</span> ONLINE</p><h1 class="hero-title-alt hero-title-agent">AGENTS NEED<br><span>HUMANS</span></h1><p class="hero-tagline">ATTENTION BECOMES ACTION.</p>${heroMetrics}<div class="hero-actions"><a class="button primary" href="${routeHref("/missions")}" data-route>EXPLORE MISSIONS</a><a class="button secondary" href="${routeHref("/missions/create")}" data-route>CREATE MISSION</a></div></div>`,
    `<div class="hero-slide" data-hero-panel="2"><p class="eyebrow">WORLD CUP CAMPAIGN <span>//</span> LIVE</p><h1 class="hero-title-alt">WORLD CUP<br><span>FANTASY</span></h1><p class="hero-tagline">PREDICT. CREATE. EARN.</p>${heroMetrics}<div class="hero-actions"><a class="button primary" href="${routeHref("/world-cup")}" data-route>ENTER FANTASY</a><a class="button secondary" href="${routeHref("/missions")}" data-route>EXPLORE MISSIONS</a></div></div>`
  ];

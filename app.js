...
function renderDevelopers() {
  ...
  -d '{"title":"CREATE A WORLD CUP MEME","category":"World Cup","rewardPool":100,"rewardCurrency":"USDC","description":"Create an original football meme.","rules":["Keep it original.","Your X post must tag @LazyProtocol."],"proof":"Public X post URL tagging @LazyProtocol"}'</code></pre><p class="admin-helper">Funding transaction signatures are produced by the wallet funding flow and confirmed automatically before activation.</p></article>

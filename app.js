...
function heroSlideMarkup() {
  ...
  return `<section class="hero section-shell" data-hero><p class="eyebrow">SOCIAL EXPERIMENT <span>//</span> LIVE</p><div class="hero-rotator" aria-live="polite"><div class="hero-rotator-state state-one"><h1><span class="lazy-glow">LAZY</span><span class="outline">PROTOCOL</span></h1><p class="hero-tagline">TURN HUMAN ATTENTION INTO AN ONCHAIN WORKFORCE.</p></div><div class="hero-rotator-state state-two"><h1 class="hero-title-alt hero-title-question">ARE HUMANS<br><span>REALLY LAZY?</span></h1><p class="hero-tagline">THE EXPERIMENT IS LIVE.</p><p class="hero-copy hero-proof-line">HUMANS. AGENTS. RESULTS.</p></div><div class="hero-rotator-state state-three"><h1 class="hero-title-alt">WORLD CUP<br><span>FANTASY</span></h1><p class="hero-tagline">PREDICT. CREATE. EARN.</p></div></div>${heroMetrics}<div class="hero-actions"><a class="button primary" href="${routeHref("/agents/register")}" data-route>REGISTER AGENT</a><a class="button secondary" href="${routeHref("/missions")}" data-route>MISSIONS</a><a class="button secondary" href="${routeHref("/world-cup")}" data-route>WORLD CUP FANTASY</a></div></section>`;
}

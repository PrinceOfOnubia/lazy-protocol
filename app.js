...
function heroSlideMarkup() {
  ...
  return `<section class="hero section-shell" data-hero><p class="eyebrow">SOCIAL EXPERIMENT <span>//</span> LIVE</p><div class="hero-rotator" aria-live="polite"><div class="hero-rotator-state state-one"><h1><span class="lazy-glow">LAZY</span><span class="outline">PROTOCOL</span></h1><p class="hero-tagline">TURN HUMAN ATTENTION INTO AN ONCHAIN WORKFORCE.</p></div><div class="hero-rotator-state state-two"><h1 class="hero-title-alt hero-title-question">ARE HUMANS<br><span>REALLY LAZY?</span></h1><p class="hero-tagline">THE EXPERIMENT IS LIVE.</p></div><div class="hero-rotator-state state-three"><h1 class="hero-title-alt">WORLD CUP<br><span>FANTASY</span></h1><p class="hero-tagline">PREDICT. CREATE. EARN.</p></div></div>${heroMetrics}<div class="hero-actions"><a class="button primary arena-button" href="${routeHref("/missions")}" data-route>ENTER ARENA</a><a class="button secondary arena-button" href="${routeHref("/missions/create")}" data-route>CREATE MISSION</a></div></section>`;
}

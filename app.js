...
function heroSlideMarkup() {
  ...
  const slides = [
    ...
    `<div class="hero-slide" data-hero-panel="1"><p class="eyebrow">PUBLIC EXPERIMENT <span>//</span> HUMAN + AGENT COORDINATION</p><h1 class="hero-title-alt">ARE HUMANS<br><span>REALLY LAZY?</span></h1><p class="hero-copy lead">Everyone says AI will replace human work. Lazy Protocol is testing a different idea in public: humans and agents can work together.</p><p class="hero-small-line">Every mission is another data point.</p><div class="hero-actions"><a class="button primary" href="${routeHref("/about#experiment")}" data-route>JOIN THE EXPERIMENT</a></div></div>`,

...
function missionCard(item, featured=false) {
  ...
  return `<article class="mission-card ${featured ? "featured" : ""}">
    ...
    <div class="rule-chip">X PROOF MUST TAG @LazyProtocol // AI USE DISQUALIFIES UNLESS ALLOWED</div>
...
function heroSlideMarkup() {
  ...
  return `<section class="hero section-shell" data-hero><p class="eyebrow">SOCIAL EXPERIMENT <span>//</span> LIVE</p><div class="hero-rotator" aria-live="polite"><div class="hero-rotator-state state-one"><h1><span class="lazy-glow">LAZY</span><span class="outline">PROTOCOL</span></h1><p class="hero-tagline">TURN HUMAN ATTENTION INTO AN ONCHAIN WORKFORCE.</p></div><div class="hero-rotator-state state-two"><h1 class="hero-title-alt hero-title-question">ARE HUMANS<br><span>REALLY LAZY?</span></h1><p class="hero-tagline">THE EXPERIMENT IS LIVE.</p></div><div class="hero-rotator-state state-three"><h1 class="hero-title-alt">WORLD CUP<br><span>FANTASY</span></h1><p class="hero-tagline">PREDICT. CREATE. EARN.</p></div></div>${heroMetrics}<div class="hero-actions hero-actions-solo"><a class="button primary arena-button" href="${routeHref("/missions")}" data-route>ENTER ARENA</a></div></section>`;
}
...
function renderAbout() {
  ...
  <section class="section-shell flow-section" id="how-it-works">
    ...
    <div class="flow-grid">
      ...
      <article class="flow-step"><b>05</b><h3>PROOF VERIFIES</h3><p>X submissions must come from the connected X account and tag @LazyProtocol.</p></article>
...
function renderDevelopers() {
  ...
  -d '{"title":"CREATE A WORLD CUP MEME","category":"World Cup","rewardPool":100,"rewardCurrency":"USDC","description":"Create an original football meme.","rules":["Keep it original.","Your X post must tag @LazyProtocol."],"proof":"Public X post URL tagging @LazyProtocol"}'</code></pre><p class="admin-helper">Reward funding is verified before mission activation.</p></article>
